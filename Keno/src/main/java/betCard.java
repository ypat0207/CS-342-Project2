...
public class betCard {
    public int numSpots;
    public int numDraws;
    public ArrayList<Integer> chosenSpots = new ArrayList();
    ...
    public void manualGrid() {
      ...
      ArrayList<Integer> chosenSpotsManualGrid = new ArrayList();
      	chosenSpotsManualGrid.clear();
        grid.setPadding(new Insets(40,1,1,100));
    	grid.setHgap(1);
    	grid.setVgap(2);
    	for(int row = 1; row <= 8; row++) {
    		for(int col = 1; col <= 10; col++) {
    			...
    			if(chosenSpotsManualGrid.contains(index)) {
...
//    		    });
    	...
    	chosenSpots.addAll(chosenSpotsManualGrid);
    ...
    public void chooseRandom() {
    	...
    	grid2.setPadding(new Insets(40,1,1,100));
    	grid2.setHgap(1);
    	grid2.setVgap(2);
    	for(int row = 1; row <= 8; row++) {
    		for(int col = 1; col <= 10; col++) {

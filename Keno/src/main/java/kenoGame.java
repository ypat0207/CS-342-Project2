...
public class kenoGame {
    ...
    public int getSpotsMatched() {return spotsMatched;}
    public void setSpotsMatched(int spots) {spotsMatched = spots;}
    public ArrayList<Integer> getDrawNums() {return drawNums;}
    public void clearDrawNums() {drawNums.clear();}
    public ArrayList<ArrayList<Integer>> getBoard() {return board;}
    public double getCurrentPayout() {return currentPayout;}

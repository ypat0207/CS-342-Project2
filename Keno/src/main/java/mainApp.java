...
public class mainApp extends Application {
	...
	try {
	    FileInputStream cardSceneBG = new FileInputStream("src/main/resources/casino.jpeg");
	...
	try {
	    FileInputStream gameSceneBG = new FileInputStream("src/main/resources/casino.jpeg");
	...
	menu.getItems().addAll(iRules, iOdds, iExit);
	...
	FileInputStream imageStream = new FileInputStream("src/main/resources/keno.png");
	...
	FileInputStream background = new FileInputStream("src/main/resources/WealthyBitterBlackbear-max-1mb.gif");
	...
	FileInputStream scene2Background = new FileInputStream("src/main/resources/casino.jpeg");
